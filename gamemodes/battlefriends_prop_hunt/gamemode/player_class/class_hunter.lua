...
function CLASS:Loadout(pl)
    ...
    pl:Give("weapon_smg1")
	pl:Give("item_ar2_grenade") // should be item_ammo_smg1_grenade??
    pl:Give("weapon_357")
...
function CLASS:OnSpawn(pl)
	...
	local unlock_time = math.Clamp(GetConVar("bph_hunter_blindlock_time"):GetInt() - (CurTime() - GetGlobalFloat("RoundStartTime", 0)), 0, GetConVar("bph_hunter_blindlock_time"):GetInt())
